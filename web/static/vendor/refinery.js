...
var _user$project$Refinery$main = {
	main: A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Welcome to the Refinery!')
			]))
};

var Elm = {};
Elm['Refinery'] = Elm['Refinery'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Refinery'], 'Refinery', typeof _user$project$Refinery$main === 'undefined' ? null : _user$project$Refinery$main);
